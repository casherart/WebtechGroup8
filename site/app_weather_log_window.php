...
?>
	...
	<select name="trip_log" id="trip" class="select-long">
    	<?php
	...
	<div class="control-group">
        ...
        <input type="submit" class="btn" id="startStopWeatherLog" name="submit" value="Start Logging" class="button"onclick="startStopWeatherLog()"/>
    </div>