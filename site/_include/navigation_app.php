...
<div class="navbar">
	<div class="navbar-inner">
		<div class="container">		
			...
			<ul class="navbar-form pull-right" style="list-style-type: none;">
				<li <?php if ($filename != "app_map") echo("style='visibility:hidden'")?>><a class="btn" id="startLog" title="Wetter-Aufzeichnung" onclick="openWeatherLogWindow();"><i class="icon-pencil"></i></a><li>
			</ul>
		</div>
	</div>
</div>
