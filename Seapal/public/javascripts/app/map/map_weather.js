        ...
        if (data) {
            ...
            if (time == "weather") {
                ...
                if (target == "log") {
                    ...
                    $("#time").text("");
                    $("#weatherDisplayTop").css("background-image", "url(/assets/stylesheets/img/icons/weather_icons/" + getWeatherIcon(data.dt, data.temp.day.toFixed(0), CloudIdToDescription(data.clouds), rainIdTorainDescription(data.rain)) + ".png)");
                }
            } else {
...
function fillForecastRows(index, data) {
    ...
    $("#boxIcon" + index).css("background-image", "url(/assets/stylesheets/img/icons/weather_icons/" + getWeatherIcon(data.dt, data.temp.day.toFixed(0), CloudIdToDescription(data.clouds), rainIdTorainDescription(data.rain)) + ".png)");
